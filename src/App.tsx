...
const LandingPage: React.FC = () => {
    ...
    const { create: sendJoinRequest, remove: deleteJoinRequest } =
        useRequests();
    const { user } = useUser();
    ...
    useEffect(() => {
        const checkPermissions = async () => {
            if (window.location.pathname === "/shrek" && user) {
                    ...
                    <Content style={styles.content}>
                        <Space direction="vertical" style={{ width: "100%" }}>
                            ...
                            <Card title="משתמשים מורשים" style={styles.card}>
                                <List
                                    style={{ overflow: "auto" }}
                                    dataSource={authedUsers?.flatMap(
                                        ({ emails }) => emails
                                    )}
                                    renderItem={(email) => (
                                        <List.Item
                                                ...
                                                <Row gutter={16}>
                                                    ...
                                                    <Col xs={24} sm={12} md={6}>
                                                        <Form.Item
                                                            ...
                                                            label="באיזה תחום הבת / בן זוג עוסק/ת?"
                                                        >
                                                            <Input />
                                                        </Form.Item>
                                                    </Col>
                                                    <Col xs={24} sm={12} md={6}>
                                                        <Form.Item
                                                            name="hobbies"
                                                            label="יש לך תחביבים / תחומי עניין?"
                                                        >
                                                            <Select
                                                                mode="tags"
                                                                style={{
                                                                ...
                                                                placeholder="בחר או הזן תחביבים"
                                                            >
                                                                <Option value="ספורט">
                                                                    ספורט
                                                                </Option>
